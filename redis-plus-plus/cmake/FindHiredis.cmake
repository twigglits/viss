message(STATUS "DEBUG: Entering FindHiredis.cmake")
...
if(hiredis_FOUND)
    ...
    message(STATUS "DEBUG: HIREDIS_HEADER=${HIREDIS_HEADER}")
    message(STATUS "DEBUG: HIREDIS_LIB=${HIREDIS_LIB}")
    message(STATUS "DEBUG: hiredis_FOUND=${hiredis_FOUND}")
